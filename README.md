...
- Optional:
    - Viết logic update vị trí tàu trên bản đồ bẳng ID để tránh nháy khi update
    - Popup hiển thị thông tin cập nhật realtime thay vì thông tin lúc bấm vào
    - Viết QtQuickPaintedItem để vẽ Ship marker thành dạng mũi tên
    - Cho phép đổi màu vùng watch
    - Thêm icon cho các nút
    - Tính năng bấm vào tàu sẽ hiện các vị trí cũ (chắc là ko kịp đâu)
